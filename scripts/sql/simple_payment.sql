...
INSERT INTO products (name, description, image_url, sku, price, stock, category) VALUES
    ('Chives', 'Aromatic plant from the lily family, used as a condiment in various dishes for its mild onion-like flavor', 'farming/cebollines-min.jpg', 'CB7845A2Z9', 5000.00, 100,'Farming'),
    ...
    ('Lemon', 'Acidic citrus used to season and flavor drinks and dishes, rich in vitamin C', 'farming/limon-min.jpg', 'LM6723K9P1', 1300.00, 100,'Farming'),
    ('Bananas', 'Energetic tropical fruit rich in potassium and fiber, grown in warm and humid climates', 'farming/bananos-min.jpg', 'BN4587D2J6', 1100.00, 100,'Farming'),
    ('Onion', 'Variety of onion with large bulb and intense flavor, essential in the base of many culinary preparations', 'farming/cabezona-min.jpg', 'CB5291H8M3', 1800.00, 100,'Farming'),
    ('Green Onion', 'Variety of long-stemmed onion used in soups, stews, and as a fresh condiment in traditional cooking', 'farming/cebolla-larga-min.jpg', 'CL9634R5T7', 1500.00, 100,'Farming'),
    ('Coriander', 'Aromatic herb with fresh leaves and distinctive flavor, widely used in Latin American cuisine', 'farming/cilantro-min.jpg', 'CI2378L4N9', 900.00, 100,'Farming'),
    ('Plums', 'Sweet and juicy fruit with antioxidant and digestive properties, available in various varieties', 'farming/ciruelas-min.jpg', 'CR8145V6B2', 2700.00, 100,'Farming'),
    ('Coffee', 'Bean cultivated in mountainous areas, processed and roasted for the preparation of the popular stimulating beverage', 'farming/cafe-min.jpg', 'CF7329Q1S8', 6700.00, 100,'Farming'),
    ('Corn', 'Basic cereal in Latin American diet, cultivated in various varieties for fresh and processed consumption', 'farming/maiz-min.jpg', 'MZ5812Y3C4', 1500.00, 100,'Farming'),
